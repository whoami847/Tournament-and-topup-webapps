...
export default function EditTournamentClient({ initialTournament }: { initialTournament: Tournament }) {
    ...
    useEffect(() => {
        // We already have initial data, so we don't need to fetch on first load.
        // We can set up a listener or rely on refetching after updates.
    }, []);
